...
alldata = arff.load(open('/home/bcelik/DATA/SEA_500k.arff', 'r'),encode_nominal=True)
...
cls = autosklearn.classification.AutoSklearnClassifier(ml_memory_limit=12288, time_left_for_this_task=1800, ensemble_size = 30, ensemble_nbest =30)

X = B[42].iloc[:,0:-1]
y = B[42].iloc[:,-1]
cum_X_list.append(B[42].iloc[:,0:-1])
cum_y_list.append(B[42].iloc[:,-1])
