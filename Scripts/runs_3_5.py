...
#alldata = arff.load(open('/home/bilgecelik/Dropbox/PhD/ECML2019/Experiments/DATA/Forestcover.arff', 'r'),encode_nominal=True)
#categorical_columns =[10:54]
...
alldata = arff.load(open('/home/bcelik/DATA/AGRAWAL_1M.arff', 'r'),encode_nominal=True)
